...
function soong_build_go
{
    BUILDDIR=$(getoutdir) \
      ...
      EXTRA_ARGS="-pkg-path android/soong=${TOP}/build/soong -pkg-path aospa/soong=${TOP}/vendor/zest/build/soong -pkg-path github.com/golang/protobuf=${TOP}/external/golang-protobuf" \
      build_go $@
}
